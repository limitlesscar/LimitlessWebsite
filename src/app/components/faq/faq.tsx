    ...
    return (
      ...
      <div className="max-w-3xl mx-auto mt-10 space-y-6">
        {faqs.map((faq, index) => (
          ...
          >
            <Disclosure as="div" className="p-6 bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">
              {({ open }) => (
                <>
                  <DisclosureButton className="flex w-full justify-between text-left text-lg font-semibold text-white">
                  ...
                  <DisclosurePanel as="div" className="mt-3 text-white text-base leading-relaxed">
                    {t(faq.answer)}
                  </DisclosurePanel>
                </>
              )}
